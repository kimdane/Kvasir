...
'Adjacent Network': 'Nærtstående Nettverk',
...
'Autentication': 'Autentisering nødvendig for å utnytte',
'Authentication': 'Autentisering nødvendig for å utnytte',
'Availability Impact': 'Konsekvens for Tilgjengelighet',
'Back': 'Back',
'Banner': 'Banner',
...
'by': 'etter',
'C': 'C',
'Can only be run in background': 'Can only be run in background',
...
'Customer HTML Report': 'Kunde Rapport HTML',
...
'Domains Discovered': 'Domener Funnet',
'Download': 'Last Ned',
'Duration': 'Varighet',
'E-mail': 'E-post',
'Edit': 'Rediger',
...
'Id': 'Id',
'ID': 'ID',
'Ignore Hostfilter': 'Ignore Hostfilter',
'Import': 'Importer',
...
'Jernbaneverket HTML Report': 'Jernbaneverket HTML Report',
'JSON': 'JSON',
...
'No vulnerable hosts': 'Ingen sårbare maskiner',
'None': 'Ingen',
'None required': 'Ikke påkrevd',
'not in': 'ikke i',
'Note': 'Notat',
'Notes': 'Notater',
'Number': 'Nummer',
...
'Use Kvasir static path': 'Use Kvasir static path',
'Use local file path': 'Use local file path',
'User': 'Bruker',
'User ID': 'BrukerID',
'Username': 'Brukernavn',
...
'Vuln->Reference Links': 'Sårbarhet->Referanse Lenker',
'VulnCircles': 'SårbarhetsSirkler',
'VulnDB': 'SårbarhetsDB',
'Vulnerabilities': 'Sårbarheter',
'Vulnerability': 'Sårbarhet',
'Vulnerability ID': 'SårbarhetsID',
'Vulnerability Information': 'Sårbarhetsinformasjon',
'Vulnerability List': 'Liste over Sårbarheter',
