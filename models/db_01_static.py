...
db.define_table('t_vulndata',
    ...
    Field('f_cvss_a', type='string', label=T('CVSS Availablity Impact'),
          requires=IS_EMPTY_OR(IS_IN_SET([('N', 'None'), ('P', 'Partial'), ('C', 'Complete')]))),
    Field('f_description', type='text', length=16777215, represent=lambda x, row: MARKMIN(x), label=T('Description')),
    Field('f_solution', type='text', length=16777215, represent=lambda x, row: MARKMIN(x), label=T('Solution')),
